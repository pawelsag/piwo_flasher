...
constexpr int flash_frame_header_length   = flash_frame_data_size + flash_frame_checksum_size + 2;
...
constexpr int flash_frame_checksum_pos      = common_type_pos + 2;
constexpr int flash_frame_payload_pos       = common_type_pos + 3;
